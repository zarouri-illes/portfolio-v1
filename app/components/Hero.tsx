        ...
        <div className="mt-0 ">
            <div className="lg:px-12 px-4 flex flex-col md:flex-row-reverse items-center justify-between py-24 gap-5">
                ...
                <div className="md:w-1/2 w-full mt-5">
                    ...
                    <h1 className="md:text-4xl text-3xl font-bold text-heading leading-snug md:leading-[50px] mb-5">I am a <span className="text-primary">front-end developer</span> and a <span className="text-primary">Coach</span>.</h1>
